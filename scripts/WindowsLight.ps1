#To run use powershell(ADM):
# This is an script to optimize your windows instalation, removing some unused options, software(bloatware) and doing some tweaks.
# is only my own compilation of many windows debloat scripts that i follow on gitHub and was write based on CrisTitus debloat script.
# https://github.com/ChrisTitusTech/win10script 
#
# .\WindowsLight.ps1
# or
# powershell -nop -c "WindowsLight.ps1"
...
$tweaks = @(
	...
	"UninstallMsDefaultApps",       # "InstallMsDefaultApps",
	"Stop-EdgePDF",
	"DisableApplicationSuggestions",
	...
	#"DisableDriverUpdateAtWindowsUpdate"
...
Function DisableApplicationSuggestions 
{
...
Function UninstallMsDefaultApps {
...
# Disable Driver Update At WindowsUpdate
Function DisableDriverUpdateAtWindowsUpdate {
